...
const Rashi = () => {
  ...
  const selectedRashiLetters = rashiInitials[selectedRashi];

  const uniqueNames = [...new Set(filteredData.map((entry) => entry.Name))];

  const totalPages = Math.ceil(uniqueNames.length / itemsPerPage);
        ...
        <div className="shadow-lg border-4 bg-white/80 w-full border-black-500/100 dark:border-white-500/100 p-4 rounded-3xl dark:bg-black/35">
          <div className="flex justify-between mb-5">
            ...
            >
              ...
              <option value="Vruschika">Vruschika - Scorpio</option>
            </select>
          </div>
              ...
              <table class="w-full text-sm text-left ">
                <tbody>
                  <tr class="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">{selectedRashi}</td>
                  </tr>
                  <tr class="border-b border-gray-200 dark:border-gray-700">
                    <th
                      scope="row"
                  ...
                  <tr class="border-b border-gray-200 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">{selectedRashiLetters.join(", ")}</td>
                  </tr>
                </tbody>
              </table>
            </div>
