        ...
        <div className="lg:w-1/3">
          <div className="flex items-center rounded-full">
            <Link href="/" className="w-full xl:w-auto">
              <Image
                className="w-60 m-auto max-h-screen"
                src={logo}
                alt="Logo"
              />
            </Link>
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li>
                <Link href="/names/numerology" className="w-full xl:w-auto">
                  Numerology
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/rashi" className="w-full xl:w-auto">
                  Rashi
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li>
                <Link href="/company/privacy" className="w-full xl:w-auto">
                  Privacy
                </Link>
              </li>
              <li>
